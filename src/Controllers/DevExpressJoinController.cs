...
{
    internal static class DevExpressJoinController
    {
        internal static async Task<IResponse> SaveAsync(this ICore core, DevExpressJoinSaveModel save)
        {
        ...
        internal static async Task<IResponse> SavePasswordChangeAsync(this ICore core, DevExpressJoinSaveModel save)
        {
            IServiceDataSet serviceDataSet;
