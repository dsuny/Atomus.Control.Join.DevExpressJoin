...
{
    public partial class DevExpressJoin : XtraUserControl, IAction
    {
            ...
            try
            {
                ...
                switch (e.Action)
                {
                    ...
                    case "UserAgreement.Rtf":
                        this.UserAgreement_Detail.RtfText = (string)e.Value;
                        return true;
                    ...
                    case "PersonalInformationCollectionAgreement.Rtf":
                        this.PersonalInformationCollectionAgreement_Detail.RtfText = (string)e.Value;
                        return true;
        ...
        private async void Join()
        {
            ...
            try
            {
                ...
                result = await this.SaveAsync(new DevExpressJoinSaveModel()
                {
        ...
        private async void Init()
        {
            ...
            try
            {
                ...
                result = await this.SavePasswordChangeAsync(new DevExpressJoinSaveModel()
                {
                    EMAIL = this.EMAIL.Text,
        ...
        private async void DefaultJoin_Load(object sender, EventArgs e)
        {
            ...
            this.layoutControl1.DoubleBuffered(true);
            this.layoutControl2.DoubleBuffered(true);
        ...
        private void New_CheckedChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                radioButton = (CheckEdit)sender;

                if (radioButton.Checked)
                {
                    this.PasswordInit.Checked = false;
                    this.EMAIL.Enabled = true;
                    this.layoutControlItem7.Text = "이메일 확인".Translate();
                    this.EMAIL_Retry.Enabled = true;
                    this.EMAIL_Retry.Properties.PasswordChar = '\0';
        ...
        private void PasswordInit_CheckedChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (RadioButton.Checked)
                {
                    this.New.Checked = false;
                    this.EMAIL.Enabled = true;
                    this.layoutControlItem7.Text = "기존 비밀번호".Translate();
                    this.EMAIL_Retry.Enabled = true;
                    this.EMAIL_Retry.Properties.PasswordChar = '*';
                    this.ACCESS_NUMBER.Enabled = true;
                    this.ACCESS_NUMBER_Retry.Enabled = true;
                    ...
                    //this.ACCESS_NUMBER_Retry.Enabled = false;
                    //this.Bnt_Join_Init.Text = "초기화".Translate();
                }
            }
            catch (Exception exception)
            {
